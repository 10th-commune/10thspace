...
) ENGINE = InnoDB AUTO_INCREMENT = 183 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户和群的关系表' ROW_FORMAT = Compact;
...
CREATE TABLE `IMGroupMessage_0`  (
  ...
  `updated` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `created` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `contentSig` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_groupId_status_created`(`groupId`, `status`, `created`) USING BTREE,
  INDEX `idx_groupId_msgId_status_created`(`groupId`, `msgId`, `status`, `created`) USING BTREE
...
CREATE TABLE `IMGroupMessage_2`  (
  ...
  `updated` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `created` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `contentSig` varbinary(150) NOT NULL DEFAULT '' COMMENT '数据签名',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_groupId_status_created`(`groupId`, `status`, `created`) USING BTREE,
  INDEX `idx_groupId_msgId_status_created`(`groupId`, `msgId`, `status`, `created`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 402 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'IM群消息表' ROW_FORMAT = Compact;
...
CREATE TABLE `IMMessage_2`  (
  ...
  INDEX `idx_relateId_status_msgId_created`(`relateId`, `status`, `msgId`, `created`) USING BTREE,
  INDEX `idx_fromId_toId_created`(`fromId`, `toId`, `status`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 111 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
...
CREATE TABLE `IMMessage_3`  (
  ...
  INDEX `idx_relateId_status_msgId_created`(`relateId`, `status`, `msgId`, `created`) USING BTREE,
  INDEX `idx_fromId_toId_created`(`fromId`, `toId`, `status`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 87 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
...
CREATE TABLE `IMMessage_6`  (
  ...
  INDEX `idx_relateId_status_msgId_created`(`relateId`, `status`, `msgId`, `created`) USING BTREE,
  INDEX `idx_fromId_toId_created`(`fromId`, `toId`, `status`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 68 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
...
-- ----------------------------
-- Table structure for IMRecommand
-- ----------------------------
DROP TABLE IF EXISTS `IMRecommand`;
CREATE TABLE `IMRecommand`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `referralCode` varchar(130) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `userId` varchar(130) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for IMReferralCode
-- ----------------------------
DROP TABLE IF EXISTS `IMReferralCode`;
CREATE TABLE `IMReferralCode`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` varchar(130) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `IMTransmitFile`  (
  ...
  `taskId` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '任务id',
  `status` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '状态',
  `created` int(11) UNSIGNED NOT NULL COMMENT '创建时间',
  `updated` int(11) UNSIGNED NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_taskId`(`taskId`(191)) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
...
CREATE TABLE `IMUser`  (
  ...
  `referralCode` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '' COMMENT '推荐码',
  PRIMARY KEY (`id`) USING BTREE,
