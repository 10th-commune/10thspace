...
void CEventDispatch::StartDispatch(uint32_t wait_timeout)
{
	struct epoll_event events[1024*100];//wystan modfiy 1024 -> 1024 * 100
	int nfds = 0;
	...
	while (running)
	{
		nfds = epoll_wait(m_epfd, events, 1024*100, wait_timeout);//wystan modfiy 1024 -> 1024 * 100
		for (int i = 0; i < nfds; i++)
		{
