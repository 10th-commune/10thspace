...
#include "business/BlogModel.h"
#include "business/SystemMsgModel.h"
...
int main(int argc, char* argv[])
{
    ...
    log("init cache manager success!");
    ...
    if (!CBlogModel::getInstance()) {
        return -1;
    }

    if (!CSystemMsgModel::getInstance()) {
        return -1;
    }
