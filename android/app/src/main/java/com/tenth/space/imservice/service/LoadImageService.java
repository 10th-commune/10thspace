...
public class LoadImageService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
       ...
       // try {
             ...
             */
            if(file.exists()){
                result = upLoad2Fastdfs(FileUtil.getFileNameFromFullPath(messageInfo.getPath()), messageInfo.getPath());
            }
            ...
            if (TextUtils.isEmpty(result)) {
                ...
                logger.i("upload image succcess,imageUrl is %s %s %s",result, messageInfo.getFromId(), messageInfo.getId());
