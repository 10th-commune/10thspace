...
public class Sha256Hash implements Serializable, Comparable {
    private byte[] bytes;
    public static final com.tenth.space.utils.Sha256Hash ZERO_HASH = new com.tenth.space.utils.Sha256Hash(new byte[32]);
     ...
     */
    public static com.tenth.space.utils.Sha256Hash create(byte[] contents) {
        try {
            MessageDigest digest = MessageDigest.getInstance("SHA-256");
            return new com.tenth.space.utils.Sha256Hash(digest.digest(contents));
     ...
     */
    public static com.tenth.space.utils.Sha256Hash createDouble(byte[] contents) {
        return new com.tenth.space.utils.Sha256Hash(Utils.doubleDigest(contents));
    }
     ...
     * @throws IOException
     */
    public static com.tenth.space.utils.Sha256Hash hashFileContents(File f) throws IOException {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof com.tenth.space.utils.Sha256Hash)) return false;
        return Arrays.equals(bytes, ((com.tenth.space.utils.Sha256Hash) other).bytes);
    }
    ...
    public com.tenth.space.utils.Sha256Hash duplicate() {
        return new com.tenth.space.utils.Sha256Hash(bytes);
    }
    ...
    public int compareTo(Object o) {
        checkArgument(o instanceof com.tenth.space.utils.Sha256Hash);
        int thisCode = this.hashCode();
        int oCode = ((com.tenth.space.utils.Sha256Hash) o).hashCode();
