...
public interface SysConstant {
    ...
    public static final int FILE_BACK_DATA = 56;
    ...
    public static final String UPLOAD_IMAGE_INTENT_PARAMS = "space3.bither.upload.image.intent";
    public static final String DFS_UPLOAD_FILE_INTENT_PARAMS = "space3.bither.upload.file.intent";
    /**
     * event 优先级
     * */
