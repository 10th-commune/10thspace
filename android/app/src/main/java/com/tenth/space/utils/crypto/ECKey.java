...
package com.tenth.space.utils.crypto;

import com.google.common.annotations.VisibleForTesting;
import com.google.common.base.Preconditions;

import com.tenth.space.utils.Sha256Hash;
...
public class ECKey implements Serializable {
    ...
    /**
     * A constructor variant with BigInteger pubkey. See {@link com.tenth.space.utils.crypto.ECKey#ECKey(BigInteger, byte[])}.
     */
...
//    }
     ...
     * usually encoded using DER format, so you want {@link com.tenth.space.utils.crypto.ECKey.ECDSASignature#toASN1()}
     * instead. However sometimes the independent components can be useful, for instance, if you're doing to do
     * further EC maths on them.
     *
     * @throws com.tenth.space.utils.crypto.KeyCrypterException if this ECKey doesn't have a private part.
     */
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link com.tenth.space.utils.crypto.ECKey.ECDSASignature#encodeToDER()}
...
//        signature.ensureCanonical();
     ...
     * @throws com.tenth.space.utils.crypto.KeyCrypterException if this ECKey is encrypted and no AESKey is provided or it does not decrypt the ECKey.
     */
...
//            throw new IllegalStateException("This ECKey does not have the private key necessary for signing.");
    ...
    /**
     * Convenience wrapper around {@link com.tenth.space.utils.crypto.ECKey#signedMessageToKey(String, String)}. If the key derived from the
