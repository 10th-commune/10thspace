...
public class DiscoverFragment extends Fragment implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    private RadioButton rbSomeOne;
    private RadioButton rbSomeGroup;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.tt_fragment_discover, null);
        initView();
        initViewPager();
    ...
    private void initView() {
        ...
        rbSomeGroup = (RadioButton) mView.findViewById(R.id.rb_findSomeGroup);
        rbSomeOne = (RadioButton) mView.findViewById(R.id.rb_findSomeOne);
    ...
    private void initViewPager() {
        ...
        FindSomeOneFragment someOneFragment = new FindSomeOneFragment();
        fragmentList.add(someOneFragment);
        FindSomeGroupFragment someGroupFragment = new FindSomeGroupFragment();
        fragmentList.add(someGroupFragment);
        //ViewPager设置适配器
    ...
    public void onPageSelected(int position) {
        switch (position) {
            case 0:
                rbSomeOne.setChecked(true);
                mGroup.check(R.id.rb_findSomeOne);
                break;
            case 1:
                rbSomeGroup.setChecked(true);
                mGroup.check(R.id.rb_findSomeGroup);
                break;
        }
    }
    ...
    private class myCheckChangeListener implements RadioGroup.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            switch (checkedId) {
                case R.id.rb_findSomeGroup:
                    //ViewPager显示第一个Fragment且关闭页面切换动画效果
                    mPager.setCurrentItem(1);
                    break;
                case R.id.rb_findSomeOne:
                    mPager.setCurrentItem(0);
                    break;
            }
        }
