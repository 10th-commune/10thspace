...
public class MessageImageFragment extends android.support.v4.app.Fragment {
    ...
    private Logger logger = Logger.getLogger(MessageImageFragment.class);
    ...
    private void initData() {
        try {
            ...
            ImageLoaderUtil.instance().displayImage(IMApplication.app.UrlFormat(imageUrl), view, new DisplayImageOptions.Builder()
                    .cacheInMemory(false)
                    .cacheOnDisk(true)
