...
public class SessionEntity {
    ...
    public SessionEntity(Long id, String sessionKey, String peerId, int peerType, int latestMsgType, int latestMsgId, String latestMsgData, String talkId, int created, int updated) {
        this.id = id;
