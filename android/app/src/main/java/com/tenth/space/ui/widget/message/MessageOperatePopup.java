...
public class MessageOperatePopup implements View.OnClickListener, View.OnTouchListener {
    ...
    private TextView copyBtn, resendBtn, speakerBtn, quoteBtn;
    private boolean bcopyShow, bresendShow, bspeakerShow, bquoteShow;
    ...
    private MessageOperatePopup(Context ctx, View parent) {
        mview = LayoutInflater.from(ctx).inflate(R.layout.tt_popup_list,
                null);
        this.context = ctx;

        // popView = (LinearLayout) view.findViewById(R.id.popup_list);

        copyBtn = (TextView) mview.findViewById(R.id.copy_btn);
        copyBtn.setOnClickListener(this);
        copyBtn.setOnTouchListener(this);
        copyBtn.setPadding(0, 13, 0, 8);

        resendBtn = (TextView) mview.findViewById(R.id.resend_btn);
        resendBtn.setOnClickListener(this);
        resendBtn.setOnTouchListener(this);
        resendBtn.setPadding(0, 13, 0, 8);

        speakerBtn = (TextView) mview.findViewById(R.id.speaker_btn);
        speakerBtn.setOnClickListener(this);
        speakerBtn.setOnTouchListener(this);
        speakerBtn.setPadding(0, 13, 0, 8);

        quoteBtn = (TextView) mview.findViewById(R.id.quote_btn);
        quoteBtn.setOnClickListener(this);
        quoteBtn.setOnTouchListener(this);
        quoteBtn.setPadding(0, 13, 0, 8);
    ...
    public void show(View item, int type, boolean bResend, boolean bSelf) {
        ...
        if (bResend && bSelf) {
            ...
            if (type == DBConstant.SHOW_ORIGIN_TEXT_TYPE) {
                ...
                bcopyShow = false;
                quoteBtn.setVisibility(View.GONE);
                bquoteShow = false;
            }
        ...
        if (bcopyShow && bresendShow) {
            ...
            copyBtn.setPadding(0, 13, 0, 8);
            //quoteBtn.setBackgroundDrawable(bgLeft);
            quoteBtn.setPadding(0, 13, 0, 8);
            ...
            if (bspeakerShow) {
                ...
                mview.setBackground(bgNormal);
                             /*
                copyBtn.setBackgroundDrawable(bgNormal);
                quoteBtn.setBackgroundDrawable(bgNormal);
    ...
    public void onClick(View v) {
        ...
        }else if (R.id.quote_btn == id) {
            dismiss();
            if (mListener != null) {
                mListener.onQuoteClick();
            }
        }
    }
        ...
        if (event.getAction() == MotionEvent.ACTION_UP) {
            if (R.id.copy_btn == v.getId()) {
                ...
                if (drawable != null) {
                    ...
                    copyBtn.setPadding(0, 13, 0, 8);
                   // quoteBtn.setBackgroundDrawable(drawable);
                    quoteBtn.setPadding(0, 13, 0, 8);
                }
            ...
            if (R.id.copy_btn == v.getId()) {
                ...
                if (drawableCopy != null) {
                   // copyBtn.setBackgroundDrawable(drawableCopy);
                    copyBtn.setPadding(0, 13, 0, 8);
                 //   quoteBtn.setBackgroundDrawable(drawableCopy);
                    quoteBtn.setPadding(0, 13, 0, 8);
                }
