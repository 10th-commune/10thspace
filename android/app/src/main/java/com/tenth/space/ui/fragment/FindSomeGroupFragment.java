...
public class FindSomeGroupFragment extends MainFragment implements SortSideBar.OnTouchingLetterChangedListener {
    ...
    public FindSomeGroupFragment(int unreadBuddyAddCnt) {
        this.unreadBuddyAddCnt = unreadBuddyAddCnt;
    }

    public FindSomeGroupFragment() {
    ...
    private IMServiceConnector imServiceConnector = new IMServiceConnector() {
        ...
        public void onIMServiceConnected() {
            ...
            initAdapter();
            renderEntityList();
            EventBus.getDefault().registerSticky(FindSomeGroupFragment.this);
        ...
        public void onServiceDisconnected() {
            if (EventBus.getDefault().isRegistered(FindSomeGroupFragment.this)) {
                EventBus.getDefault().unregister(FindSomeGroupFragment.this);
            }
        }
    };
    //    private Button add;
...
//        requesterEntity =DBInterface.instance().getReqestLastTime();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        curView = inflater.inflate(R.layout.tt_fragment_findsomegroup, topContentView);
        initRes();
        initData();
        return curView;
    }
