...
public class Base58 {
    ...
    public static CharSequence encodeChecked(byte[] input) {
        ...
        return com.tenth.space.utils.Base58.encode(result);
    }

    public static byte[] decode(String input) throws AddressFormatException {
        if (input.isEmpty() || input.length() == 0) {//wystan modify 201218
            return new byte[0];
        }
...
//    }
    ...
    public static byte[] decodeChecked(String input) throws AddressFormatException {
        ...
        if (!Arrays.equals(checksum, hash))
            throw new AddressFormatException(input + " :Checksum does not validate");
    ...
    public static String bas58ToHexWithAddress(String address) throws AddressFormatException {
        byte[] bytes = com.tenth.space.utils.Base58.decodeChecked(address);
