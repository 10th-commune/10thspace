...
package com.tenth.space.ui.adapter.album;
...
public class AlbumHelper {
    ...
    private void buildImagesBucketList() {
        ...
        try {
            ...
            if(!bucketList.isEmpty())//wystan modify 210316
...
//					logger.i("pic#photo set name:%s", lhs.bucketName);
					...
					logger.i("pic#name:%s, lhsDefaultCameraSet:%s", lhs.bucketName, lhsDefaultCameraSet);
					logger.i("pic#name:%s, rhsDefaultCameraSet:%s", rhs.bucketName, rhsDefaultCameraSet);
