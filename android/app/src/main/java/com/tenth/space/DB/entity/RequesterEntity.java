...
public class RequesterEntity implements Serializable{
    ...
    public RequesterEntity(Long id, String avatar_url, Long created, Boolean isRead, Boolean isGroup, String nick_name, String fromUserId, String addition_msg, int agree_states) {
        this.id = id;
